// --------------------------------------------------------------------------------------------------------------------
// <copyright company="TEST" file="Program.cs">
//   
// </copyright>
// <summary>
                        ...
                        switch (choix2)
                        {
                            case "1":
                                ...
                                if (typeContact == "Privé")
                                {
                                    ...
                                    do
                                    {
                                        Console.WriteLine("Entrer la date de naissance : (Format : 00/00/0000");
                                        date = Console.ReadLine();
                                        const char VerifA = '/';
                                        countA += date.Count(t => t == VerifA);
                                        if (countA != 2 && date.Length != 10)
                                        {
                                            Console.WriteLine("Mauvais format de la date, retaper");
                                        }
                                    ...
                                    while (countA != 2 && date.Length != 10 && date[2] != '/' && date[5] != '/');
                            ...
                            case "2":
                                ...
                                Console.WriteLine(gestionAnnuaire.ListeContact[supp].Affiche());
                                Console.WriteLine("Etes-vous sur de vouloir supprimer le contact ? \n 1- Oui \n 2- Non");
                                var csupp = Convert.ToInt32(Console.ReadLine());
                                switch (csupp)
                                {
                                    case 1:
                                    ...
                                    case 2:
                                        ...
                                        break;
                                    default:
                                        Console.WriteLine("Veuillez choisir un choix possible");
                                        break;
                                }
                            ...
                            case "3":
                                ...
                                try
                                {
                                    Console.WriteLine("Vous avez sélectionnez :\n");
                                    Console.WriteLine(gestionAnnuaire.ListeContact[mod].Affiche() + "\n");
