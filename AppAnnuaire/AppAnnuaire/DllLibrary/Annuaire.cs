namespace DllLibrary
{
    ...
    public class Annuaire
    {
        ...
        public void ImportDat(string chemin)
        {
            ...
            foreach (var t in arrLines)
            {
                ...
                else if (datType == "Pro")
                {
                    ...
                    this.Ajouter(new ContactPro(id, datType, datNom, datPrenom, datTelephone, datMail, datEntreprise));
        ...
        public void ImportXml(string chemin)
        {
            ...
            for (var i = 0; i < doc["Annuaire"].ChildNodes.Count; i++)
            {
                ...
                if (xmlType == "Privé")
                {
                    ...
                    this.Ajouter(new ContactPriv(xmlId, xmlType, xmlNom, xmlPrenom, xmlTelephone, xmlDate, xmlAge));
                    this.ListeContactPriv.Add(
            ...
            switch (choix)
            {
                ...
                case "4":
                    if (this.ListeContact[modif].TypeContact == "Privé")
                    {
                        ...
                        do
                        {
                            Console.WriteLine("Entrez la nouvelle date de naissance : (Format : 00/00/0000)");
                            newDate = Console.ReadLine();
                            const char VerifA = '/';

                            countA += newDate.Count(t => t == VerifA);
                            if (countA != 2 && newDate.Length != 10)
                            {
                        ...
                        while (countA != 2 && newDate.Length != 10 && newDate[2] != '/' && newDate[5] != '/');
                    }
                    else if (this.ListeContact[modif].TypeContact == "Pro")
                    {
        ...
        {
            Console.WriteLine(
                "Comment voulez-vous trier les contacts ?:\n1- Par nom\n2- Par date de naissance\n3- Par adresse mail");
