namespace DllLibrary
{
    ...
    public class Annuaire
    {
        ...
        public void ExportXML()
        {
            ...
            using (var writer = XmlWriter.Create("contactXml.xml"))
            {
                ...
                {
                    var contactPriv = ListeContact[count] as ContactPriv;
                    var contactPro = ListeContact[count] as ContactPro;
                    ...
                    if (ListeContact[count].TypeContact == "Privé")
                    {
                    ...
                    else if (ListeContact[count].TypeContact == "Pro")
                    {
        ...
        public void ImportXml(string chemin)
        {
            ...
            {
                // on selectionne un noeud spécifique que l'on met dans une varible string.
        ...
        public void ExportDat()
        {
            ...
            using (StreamWriter sw = new StreamWriter("contactDat.txt"))
            {
                foreach (var contact in ListeContact)
                {
                    var contactPriv = ListeContact[count] as ContactPriv;
            ...
            // Si le fichier contactDat.dat existe, on supprime celui ci et on chang le fichier texte en fichier dat.
        ...
        public void ImportDat(string chemin)
        {
            ...
            foreach (var t in arrLines)
            {
                ...
                if (datType == "Privé")
                {
                    ...
                    Ajouter(new ContactPriv(id, datType, datNom, datPrenom, datTelephone, datDate, datAge));
                    ListeContactPriv.Add(
        ...
        #endregion Fonctions Import/Export XML -- Import/Export DAT
        ...
        public void Modifier(int modif)
        {
            ...
            var change = ListeContact.FirstOrDefault(d => d.Id == modif);
            var changePriv = ListeContactPriv.FirstOrDefault(d => d.Id == modif);
            var changePro = ListeContactPros.FirstOrDefault(d => d.Id == modif);

            var contactPrivMod = change as ContactPriv;
            var contactProMod = change as ContactPro;

            Console.Write("que voulez vous changer ?\n" + "1 - Nom\n" + "2 - Prénom\n" + "3 - Téléphone\n");
            if (ListeContact[modif].TypeContact == "Privé")
            {
                Console.WriteLine("4 - Date de naissance\n5 - Age");
            }
            else if (ListeContact[modif].TypeContact == "Pro")
            {
        ...
        public void Rechercher()
        {
            ...
            switch (choix)
            {
                case "1":
                    ...
                    try
                    {
                        Console.WriteLine(ListeContact.Find(x => x.Nom.Equals(nom)).Affiche());
                    }
                    catch (Exception)
                    {
                ...
                case "2":
                    ...
                    {
                        Console.WriteLine(
                            ListeContactPros.Find(x => x.NomEntreprise.Equals(nameEntreprise)).Affiche());
                    }
                    catch (Exception)
                    {
                ...
                case "3":
                    ...
                    try
                    {
                        Console.WriteLine(ListeContact.Find(x => x.Telephone.Equals(numéro)).Affiche());
                    }
                    catch (Exception)
                    {
                ...
                case "4":
                    ...
                    if (choix == "1")
                    {
                        ...
                        foreach (var j in ListeContactPriv)
                        {
                    ...
                    else if (choix == "2")
                    {
                        ...
                        foreach (var j in ListeContactPros)
                        {
                            Console.WriteLine(Environment.NewLine + j.Affiche());
                            Console.WriteLine(Environment.NewLine + "---------------------");
                        }
        ...
        public void Trier()
        {
            ...
            {
                case "1":
                    var trierParNom = ListeContact.OrderBy(o => o.Nom).ToList();
                ...
                case "2":
                    var trierParN = ListeContactPriv.OrderBy(o => o.DateDeNaissance).ToList();
                ...
                case "3":
                    var trierParM = ListeContactPros.OrderBy(o => o.AdresseMail).ToList();
        ...
        {
            ListeContact.RemoveAt(supp);
            if (ListeContact[supp].TypeContact == "Privé")
            {
                ListeContactPriv.Remove(ListeContactPriv.Find(o => o.Id.Equals(supp)));
            }
            else if (ListeContact[supp].TypeContact == "Pro")
            {
                ListeContactPros.Remove(ListeContactPros.Find(o => o.Id.Equals(supp)));
            }
        }

        #endregion Fonctions pour gérer les contacts
    }
}